...
const studentsocietydaoyABI = StudentSocietyDAO.abi
...
// 获取合约实例
const studentsocietydaoyContract = new web3.eth.Contract(studentsocietydaoyABI, studentsocietydaoAddress);
...
// 导出web3实例和其它部署的合约
export {web3, studentsocietydaoyContract,myERC20Contract,myERC721Contract}